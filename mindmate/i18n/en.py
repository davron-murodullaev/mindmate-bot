...
TRANSLATIONS = {
    ...
    "friends": {
        ...
        "btn_confirm_interests": "✅ Confirm ({count}/{max} interests)",
        ...
        "photo_quality_small": "📐 Photo is too small. Please send a better-quality one.",
        "photo_quality_large": "📐 Photo is too large (over 8 MB).",
        "photo_quality_dim": "📐 Photo dimensions ({w}x{h}) are too small. Minimum is {min_dim}px.",
        "looking_for": {
            "friendship": "🤝 Friendship",
            "relationship": "💕 Relationship",
            "partner": "🚀 Partnership (business/project)",
        },
        "gender": {
            "male": "👨 Male",
            "female": "👩 Female",
    ...
    "payments": {
        ...
        "stars_payment_prompt": "Choose a plan:",
        "card_coming_soon": "💳 *Card payment coming soon.*\n\nFor now, you can pay with ⭐ Telegram Stars — fast, secure, no verification needed.",
    },

    "admin": {
        "no_access": "⛔ This command is for admins only.",
        "stats_title": "📊 *MindMate Statistics*",
        "users_header": "*👥 Users*",
        "total": "Total",
        "new_today": "New today",
        "wau": "7-day active (WAU)",
        "mau": "30-day active (MAU)",
        "friends_header": "*💝 Friend Finding*",
        "profiles": "Profiles",
        "verified": "Verified",
        "likes": "Likes",
        "matches": "Matches",
        "modules_header": "*🎓 Other Modules*",
        "exam_profiles": "Exam Mentor",
        "career_profiles": "Career Coach",
    ...
    "legal": {
        ...
        "privacy_text": "🔒 *Privacy Policy*\n\n*Updated:* 2026\n\n*What data do we collect?*\n• Telegram ID, name, language\n• Profile data (age, city, interests, photo)\n• AI conversations (to improve the service)\n• Reminders, mood, journal entries\n\n*How do we use it?*\n• To provide AI responses and recommendations\n• To find matches in the Friends section\n• To improve bot features\n\n*Third parties:*\n• OpenAI — for AI responses (anonymous, without your personal data)\n• Telegram — for message delivery\n• Nobody else\n\n*Your rights:*\n• Delete your data at any time (Settings → 🗑 Delete my data)\n• Hide your profile (Friends → 🙈)\n• Leave the bot at any time\n\n*Contact:* @your_admin_username",
        "terms_text": "📜 *Terms of Service*\n\n*By using this bot, you agree to the following terms:*\n\n1️⃣ *Age restriction:* For users 18 years and older only\n\n2️⃣ *Respect:* Disrespect, threats, and inappropriate content are strictly prohibited. AI automatically detects and blocks violations\n\n3️⃣ *Honesty:* Fake profiles, impersonation, and using others' photos are prohibited\n\n4️⃣ *AI advice:* The bot gives recommendations but cannot replace a professional psychologist, doctor, or lawyer\n\n5️⃣ *Premium:* Paid subscriptions are non-refundable. Subscriptions do not auto-renew\n\n6️⃣ *Liability:* The bot is not responsible for relationships between users\n\n7️⃣ *Changes:* Terms may be updated. You will be notified of significant changes\n\n*Contact:* @your_admin_username",
    },
