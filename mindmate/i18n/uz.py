...
TRANSLATIONS = {
    ...
    "friends": {
        ...
        "photo_quality_small": "📐 Rasm juda kichik. Iltimos, sifatliroq rasm yuboring.",
        "photo_quality_large": "📐 Rasm juda katta (8 MB dan ortiq).",
        "photo_quality_dim": "📐 Rasm o'lchami ({w}x{h}) juda kichik. Eng kamida {min_dim}px bo'lishi kerak.",
        "looking_for": {
            "friendship": "🤝 Do'stlik",
